...
config.nuve.superserviceID = '5ced291aacac60f2cf4913a1'; // default value: ''
config.nuve.superserviceKey = '20884'; // default value: ''
...
config.erizoController.publicIP = '10.10.14.15';
config.erizoAgent.publicIP = '10.10.14.15';
